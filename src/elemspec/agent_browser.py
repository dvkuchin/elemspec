...
class АгентскийБраузер:
    ...
    def проверить_локатор(self, вид: str, значение: str) -> dict[str, Any]:
        if вид == "элемент":
            ...
            локатор = команда_диалога(self._страница, значение)
        elif вид == "поле":
            ...
            локатор = заголовок_формы(self._страница, значение)
        elif вид == "заголовок диалога":
            локатор = заголовок_диалога(self._страница, значение)
        elif вид == "текст":
            ...
            raise ОшибкаАгентскогоAPI(
                ...
                "пункт навигации, заголовок формы, "
                "заголовок диалога, текст или селектор"
            )
        try:
